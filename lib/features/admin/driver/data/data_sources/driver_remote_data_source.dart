...
abstract class DriverOnlineDataSource {
  ...
  Future<ResponseWrapper<DriverModel>> updateDriver(DriverModel driver, String id);
...
class DriverOnlineDataSourceImpl implements DriverOnlineDataSource {
  ...
  @override
  Future<ResponseWrapper<DriverModel>>updateDriver(DriverModel driver, String id) async {
