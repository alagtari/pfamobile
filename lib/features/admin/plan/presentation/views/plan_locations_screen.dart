...
@RoutePage()
class PlanLocationsScreen extends StatefulWidget {
  ...
  @override
  PlanLocationsScreenState createState() => PlanLocationsScreenState();
}

class PlanLocationsScreenState extends State<PlanLocationsScreen>
...
final _animatedMoveTileUpdateTransformer =
  ...
  if (id?.startsWith(PlanLocationsScreenState._startedId) ?? false) {
  ...
  } else if (id == PlanLocationsScreenState._inProgressId) {
  } else if (id == PlanLocationsScreenState._finishedId) {
